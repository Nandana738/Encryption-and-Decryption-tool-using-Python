...
def decrypt():
    ...
    if password == "1234":
        ...
        text2 = tkinter.Text(screen2, font="Roboto 10", bg="white", relief =tkinter.GROOVE, wrap=tkinter.WORD, bd=0)
...
def main_screen():
    ...
    Button(text="ENCRYPT",height="2",width=23,bg="#ed3833",fg="white",bd=0,command=encrpyt).place(x=10,y=250)
